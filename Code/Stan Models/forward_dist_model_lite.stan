...
transformed parameters {
  vector[n_tracks] theta_track = append_row(theta_track_raw, -mean(theta_track_raw));
  vector[n_jockeys] theta_jockey = append_row(theta_jockey_raw, -mean(theta_jockey_raw));
}
